    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('party', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uk_political_parties.Party')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('constituency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='constituencies.Constituency')),
        ...
        migrations.AddField(
            model_name='person',
            name='constituencies',
            field=models.ManyToManyField(through='people.PersonConstituencies', to='constituencies.Constituency'),
        ),
        migrations.AddField(
            model_name='person',
            name='elections',
        ...
        migrations.AddField(
            model_name='person',
            name='parties',
            field=models.ManyToManyField(through='people.PartyMemberships', to='uk_political_parties.Party'),
        ),
        migrations.AddField(
